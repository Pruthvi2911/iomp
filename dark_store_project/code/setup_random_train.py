...
code = code.replace("ppo_model\"", "ppo_model_random\"")
code = code.replace("training_log.csv", "training_log_random.csv")
code = code.replace("TOTAL_TIMESTEPS = 500000", "TOTAL_TIMESTEPS = 500000") # Keeping it at 500k to be fair
code = code.replace("ppo_learning_curve.png", "ppo_learning_curve_random.png")
